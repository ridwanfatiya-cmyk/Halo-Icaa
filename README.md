...
<head>
    ...
    <style>
        ...
        .sticky-note:nth-child(even) { transform: rotate(3deg); background: #fbcfe8; }
        .sticky-note:nth-child(3n) { transform: rotate(-1deg); background: #bfdbfe; }
